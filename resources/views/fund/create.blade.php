                    ...
                    <div class="grid grid-cols-1 md:w-1/2 gap-6">
                        ...
                        <div>
                            ...
                            <x-input id="head_of_account" class="block mt-1 w-full" type="text" required
                                name="head_of_account" value="{{ old('head_of_account') }}" />
                        </div>
                        <div>
                            <x-label for="description" :value="__('Description')" />
                            <x-textarea id="description" class="block mt-1 w-full" name="description" required rows="4">{{ old('description') }}</x-textarea>
                        </div>
                        <div>
                            <x-label for="office_id" :value="__('Office')" />
                            <x-input-select id="office_id" class="block mt-1 w-full" multiple name="office_ids[]" size="5">
